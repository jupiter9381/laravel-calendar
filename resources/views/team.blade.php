    ...
    <div class="jumbotron" data-pages="parallax">
      <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
        <div class="inner">
          <!-- START BREADCRUMB -->
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">{{__('translation.teams')}}</a></li>
              ...
              <div class="card card-default">
                <div class="card-header ">
                  <div class="card-title">
                    <h5>
                      {{__('translation.team_management')}}
                    </h5>
                  </div>
                    <div class="col-sm-12 form-inline">
                      <div class="col-sm-6 form-group">
                        <button id="show-modal" class="btn btn-primary btn-cons" data-toggle="modal" data-target="#addTeamModal"><i class="fa fa-plus"></i> {{__('translation.add_row')}}
                        </button>
                    ...
                    <tbody>
                      @foreach ($teams as $value)
                        <tr>
                          ...
                          <td>
                            <button type="button" class="btn btn-success edit-team btn-xs" team-id="{{$value['id']}}" data-toggle="modal" data-target="#editTeamModal"><i class="fa fa-edit"></i></button>
                            <button type="button" class="btn btn-danger delete-team btn-xs" team-id="{{$value['id']}}" data-toggle="modal" data-target="#deleteTeamModal"><i class="fa fa-remove"></i></button>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
...
<!-- Modal -->
<div class="modal fade slide-up disable-scroll" id="addTeamModal" tabindex="-1" role="dialog" aria-hidden="false">
    ...
    <div class="modal-content-wrapper">
      <div class="modal-content">
        <div class="modal-header clearfix text-left">
          ...
          <h5><span class="semi-bold">{{__('translation.add_team')}}</span></h5>
        </div>
        <div class="modal-body">
          <form role="form" method="post" action="{{config('domain')}}/team/add">
            <div class="row">
              <div class="col-lg-6">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group">
                  <label>{{__('translation.team_member')}}</label>
...
<!-- Modal -->
<div class="modal fade slide-up disable-scroll" id="editTeamModal" tabindex="-1" role="dialog" aria-hidden="false">
  <div class="modal-dialog ">
    <div class="modal-content-wrapper">
      <div class="modal-content">
        <div class="modal-header clearfix text-left">
          ...
          <h5><span class="semi-bold">{{__('translation.edit_team')}}</span></h5>
        </div>
        <div class="modal-body">
          <form role="form" method="post" action="{{config('domain')}}/team/update">
...
<div class="modal fade slide-up disable-scroll" id="deleteTeamModal" tabindex="-1" role="dialog" aria-hidden="false">
  <div class="modal-dialog modal-lg">
    <div class="modal-content-wrapper">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="{{config('domain')}}/team/delete">
